...
gen = (function(){
    ...
    return function(source) {
        var syncGenerator = function(y, b) {
            return syncNext(source, y || defaultY, b || defaultB);
        };
        Object.defineProperties(syncGenerator, properties);
        syncGenerator.async = constant(function(y, b) {
            return asyncNext(source, y || defaultY, b || defaultB);
        });
