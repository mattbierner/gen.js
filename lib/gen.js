...
var forEach = function(source, callback, t) {
    ...
    return single(function(y, b, r) {
        return source.sync(
            function(v) { callback.call(t, v, i++); },
            function() { y(); return empty; }
        )();
    });
};
...
var reduce = function(source, callback, initial) {
    return single(function(y, b, r) {
        var p = initial;
        return r(forEach(source, function(v, i) {
            p = callback(p, v, i);
        }), noop, noop)(function() { y(p); });
    });
};
...
var sync = next.bind(undefined, function(source, y, b) {
    var continuation;
    var extract = function(v){ return continuation = v; }
    var outerY = composed.compose(extract, y);
    var outerB = composed.compose(extract, b);
    var outerR = composed.compose(extract, sync);
...
var async = next.bind(undefined, function(source, y, b) {
    ...
    setTimeout(getNext = source.source.bind(undefined,
        ...
        composed.compose(extract, async)), 0);
}); 
