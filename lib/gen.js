...
var next = function(impl, source, y, b) {
    y = y || globalY;
    b = b || globalB;
    return function(onY, onB) {
        return impl(source, function(v) {
            var val = y(v);
            if (onY) {
                onY(v);
            }
...
var sync = (function(){
    ...
    return function(onY, onB) { return next(syncNext, this.source, onY, onB); };
}());
...
var async = (function(){
    ...
    return function(onY, onB) { return next(asyncNext, this.source, onY, onB); };
}());
