...
gen = (function(){
    ...
    return function factory(source) {
        ...
        return Object.defineProperties(generator, {
            'map': {'value': bind(map, generator) },
            'filter': {'value': bind(filter, generator) },
            'reduce': {'value': bind(reduce, generator) },
            'toArray': {'value': bind(toArray, generator) },
        });
    };
}());
...
return Object.defineProperties(gen, {
    'map': {'value': function(s, c, t){ return map(gen(s), c, t); }},
    'filter': {'value': function(s, p, t){ return filter(gen(s), p, t); } },
    'reduce': {'value': function(s, c, i){ return reduce(gen(s), c, i); } },
    'toArray': {'value': function(s){ return toArray(gen(s)); } }
});
