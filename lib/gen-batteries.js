...
var takeWhile = function(source, pred, thisObj) {
    ...
    return gen(function(y, b) {
        ...
        var value = source.sync(innerY, innerB)();
        if (!condition) {
            return b();
        } else {
            ++i;
...
var reduceWhile = function(source, pred, callback, initial) {
    return gen.single(function() {
        var p = initial;
        takeWhile(source, function() {
            return pred(p);
...
/* Export
 ******************************************************************************/
gen.prototype.take = gen.prototype.take || function(c) { return take(this, c); };
gen.prototype.takeWhile = gen.prototype.takeWhile || function(p, t) { return takeWhile(this, p, t); };
gen.prototype.skip = gen.prototype.skip || function(c) { return skip(this, c); };
gen.prototype.skipWhile = gen.prototype.skipWhile || function(p, t) { return skipWhile(this, p, t); };
gen.prototype.count = gen.prototype.count || function() { return count(this); };
gen.prototype.any = gen.prototype.any || function(p, t) { return any(this, p, t); };
gen.prototype.every = gen.prototype.every || function(p, t) { return every(this, p, t); };
