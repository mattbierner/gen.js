 ...
 */
var any = function(source, pred, thisObj) {
    var condition;
    return gen(function(y, b) {
        if (condition !== undefined) return b();
        condition = false;
        takeWhile(source, function(v, i) {
            return !condition;
        }, noop).forEach(function(v, i) {
            condition = pred.call(thisObj, v, i)
        })();
        return y(!!condition);
    });
 ...
 */
var every = function(source, pred, thisObj) {
    var condition;
    return gen(function(y, b) {
        if (condition !== undefined) return b();
        condition = true;
